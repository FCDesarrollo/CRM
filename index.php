			...
			<div class="container">
		        ...
		        <div id="navbar" class="navbar-collapse collapse">
		          <ul class="nav navbar-nav navbar-right">
		            ...
		            <li><a href="#" data-nav-section="work"><span>Nosotros</span></a></li>
		            ...
		            <li><a href="#" data-nav-section="Iniciar Sesion"><span>Iniciar Sesión</span></a></li>
		          </ul>
				</div>
			    </nav>
			  <!-- </div> -->
			...
			<div class="row row-bottom-padded-lg">
				<div class="fh5co-block to-animate" style="background-image: url(images/img_7.jpg);">
					...
					<div class="fh5co-text">
						...
						<h2>Diseña</h2>
						<p>Te ofrecemos diferentes planes adaptados a tu necesidad</p>
						<p><a href="#" class="btn btn-primary">Contactenos</a></p>
					</div>
				</div>
				<div class="fh5co-block to-animate" style="background-image: url(images/img_8.jpg);">
					...
					<div class="fh5co-text">
						...
						<h2>Crea</h2>
						<p>Lleva el control de tu contabilidad con nosotros de una manera práctica y segura</p>
				...
				<div class="fh5co-block to-animate" style="background-image: url(images/img_10.jpg);">
					...
					<div class="fh5co-text">
						...
						<h2>Disfruta</h2>
						<p>El placer y la comodidad de encontrar todo en una sola web</p>
