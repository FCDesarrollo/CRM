	...
	<div class="modal-dialog modalSelect3" style="max-width: 575px;">
		<div class="modal-content">
            ...
            <div class="modal-footer">
                  <button id="btnCargaCloud" type="button" onclick="CargaArchivoCloud()" class="btn btn-primary tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium">Continuar</button>
